...
public class StaticVariables {
    ...
    public static boolean isIndicatorOfLogin() {
        return INDICATOR_OF_LOGIN;
    }

    public static void setIndicatorOfLogin(boolean indicatorOfLogin) {
        INDICATOR_OF_LOGIN = indicatorOfLogin;
    }
